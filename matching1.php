...
ini_set('memory_limit',-1);
  ...
  <br>
   <center>
  <button  type="submit" form="form1" value="convert-excel" id="download-csv" >Convert-excel</button>
  </center>

  <!-- <table> -->
    <!-- <tbody> -->
      <?php
                $get = "SELECT  DISTINCT equipment AS equipment_tnb, no_meter AS meter ,alamat AS address FROM  tnb2 WHERE status = 'match'";
 ...
 var table = new Tabulator("#example-table-aa", {
    ...
    table.download("csv", "matching900.csv");
});
